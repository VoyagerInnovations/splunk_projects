...
#Declare variables
TS=$(date +"%Y-%m-%d")
updateprofile="/apps/splunk/bin/scripts/updateprofile.exp"
dump_path="/apps/splunk/bin/scripts/uploads"
debugFile="/apps/splunk/bin/scripts/logs/updateprofile.debug.$TS"
logFile="/apps/splunk/bin/scripts/logs/updateprofile.${ticket}.log"
scriptDIR="/apps/splunk/bin/scripts"
lookupDIR="/apps/splunk/etc/apps/search/lookups"
resultfile="/apps/splunk/etc/apps/search/lookups/updateprofile_${uname}_result.csv"
